                  ...
                  <div class="row">
                    ...
                    <div class="col-12">
                      <label>Vui lòng nhập mã đơn hàng để có thể xem chi tiết</label>
                        ...
                        <input class="form-control" placeholder="Nhập mã đơn hàng..." name="id" value="{{ $id }}">
              ...
              <div class="col-12">
                <div class="tracking-panel row">
                  <div class="col-md-4">
                    <div class="row">
                      <div class="tracking-item-wrapper">
                        <div class="tracking-item @if($data->status == 1) active @endif"><img class="tracking-item-img" src="@if($data->status == 1) {{ asset('public/assets/site/themes/assets/images/tracking-1_active.png') }} @else {{ asset('public/assets/site/themes/assets/images/tracking-1.png') }} @endif" alt="">
                  ...
                  <div class="col-md-4">
                    <div class="row">
                      <div class="tracking-item-wrapper">
                        <div class="tracking-item @if($data->status == 2) active @endif"><img class="tracking-item-img" src="@if($data->status == 2) {{ asset('public/assets/site/themes/assets/images/tracking-2_active.png') }} @else {{ asset('public/assets/site/themes/assets/images/tracking-2.png') }} @endif" alt="">
                  ...
                  <div class="col-md-4">
                    <div class="row">
                      <div class="tracking-item-wrapper">
                        <div class="tracking-item @if($data->status == 3) active @endif"><img class="tracking-item-img" src="@if($data->status == 3) {{ asset('public/assets/site/themes/assets/images/tracking-3_active.png') }} @else {{ asset('public/assets/site/themes/assets/images/tracking-3.png') }} @endif" alt="">
