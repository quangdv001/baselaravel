...
<div class="main">
    <div class="subpage-cover"
        ...
        <div class="page-title d-flex align-items-center justify-content-center"><span>@lang('footer.contact_3')</span></div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <ol class="breadcrumb breadcrumb-dot">
                    ...
                    <li class="breadcrumb-item active"><span>@lang('footer.contact_3')</span></li>
                </ol>
            </div>
        </div>
    </div>
