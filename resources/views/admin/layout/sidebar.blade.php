<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item nav-dropdown @if(in_array($currentRoute,['admin.slider.getList','admin.slider.getCreate'])) open @endif">
                <a class="nav-link nav-dropdown-toggle" href="#">
                    <i class="nav-icon icon-book-open"></i>Sliders</a>
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link @if(in_array($currentRoute,['admin.slider.getList'])) active @endif" href="{{ route('admin.slider.getList') }}">
                            <i class="nav-icon "></i> Danh sách</a>
                    </li>
                    @if(auth('admin')->user()->can('admin-pms', 'admin.slider.getCreate'))
                    <li class="nav-item">
                        <a class="nav-link @if(in_array($currentRoute,['admin.slider.getCreate'])) active @endif" href="{{ route('admin.slider.getCreate') }}">
                            <i class="nav-icon "></i> Thêm mới</a>
                    </li>
                    @endif
                </ul>
            ...
            @endif
            @if(auth('admin')->user()->can('admin-pms', 'admin.image.getList'))
            <li class="nav-item nav-dropdown @if(in_array($currentRoute,['admin.image.getList'])) open @endif">
                <a class="nav-link nav-dropdown-toggle" href="#">
                    <i class="nav-icon icon-present"></i>Album ảnh</a>
                <ul class="nav-dropdown-items"age>
                    <li class="nav-item">
                        <a class="nav-link @if(in_array($currentRoute,['admin.image.getList'])) active @endif" href="{{ route('admin.image.getList') }}">
                            <i class="nav-icon "></i> Danh sách</a>
                    </li>
                    @if(auth('admin')->user()->can('admin-pms', 'admin.image.getCreate'))
                    <li class="nav-item">
                        <a class="nav-link @if(in_array($currentRoute,['admin.image.getCreate'])) active @endif" href="{{ route('admin.image.getCreate') }}">
                            <i class="nav-icon "></i> Thêm mới</a>
                    </li>
                    @endif
                </ul>
