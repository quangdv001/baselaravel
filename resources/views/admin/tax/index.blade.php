                    ...
                    <table class="table table-bordered myTable1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ isset($listCategories[$v->category_id]) ? $listCategories[$v->category_id] : $category['name']  }}
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="{{ route('admin.law.getCreate', ['id' => $v->id]) }}"
                                        class="text-warning" title="sửa"><i class="fa fa-pencil-square-o icon-sm"
                                            aria-hidden="true"></i></a>
                                    -
                                    <a href="{{ route('admin.law.remove', ['id' => $v->id]) }}" onclick="return confirm('Bạn chắc chắn muốn xóa chứ ?')"
