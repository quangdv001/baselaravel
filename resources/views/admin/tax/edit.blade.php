            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        @if (isset($html) && $html != ''){!! $html !!} @else <option value="-1">{{ $category['name'] }}</option> @endif
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tag" class="form-control form-control-lg" id="tag" placeholder="tag"
                    ...
                    <a href="{{ route('admin.law.getList') }}" class="btn btn-light">Hủy</a>
                </div>
            </div>
        </div>
    </div>
